...
export class ClientApi {
  ...
  async share(messages: ChatMessage[], avatarUrl: string | null = null) {
      ...
      .concat([
        {
          from: "human",
          value:
            "Share from <a href='https://github.com/Yidadaa/ChatGPT-Next-Web'>NextChat</a>",
        },
      ]);
    ...
    const rawUrl = "https://share-gpt.cncent454518.workers.dev";
    ...
    if (resJson.id) {
      return `https://share-gpt.cncent454518.workers.dev/${resJson.id}`;
    }
  }
}
